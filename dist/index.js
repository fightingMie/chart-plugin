            ...
            return {
                ...
                render: function (text, record) {
                    ...
                    if (isNameColumn) {
                        ...
                        return (jsxRuntime.jsxs("div", __assign({ className: "cell-content", style: { display: 'flex', alignItems: 'center' } }, { children: [jsxRuntime.jsx("span", { className: "color-indicator", style: { backgroundColor: color } }), isHighlighted ? (jsxRuntime.jsx("span", { dangerouslySetInnerHTML: {
                                        __html: displayText.replace(new RegExp(searchText, 'gi'), function (match) { return "<span class=\"highlight\">".concat(match, "</span>"); }),
                                    } })) : (displayText)] })));
                    }
                    return (jsxRuntime.jsx("div", __assign({ className: "cell-content" }, { children: isHighlighted ? (jsxRuntime.jsx("span", { dangerouslySetInnerHTML: {
                                __html: displayText.replace(new RegExp(searchText, 'gi'), function (match) { return "<span class=\"highlight\">".concat(match, "</span>"); }),
                            } })) : (displayText) })));
                },
                filterDropdown: isSearchableColumn ? function (_a) {
                    ...
                    return (jsxRuntime.jsxs("div", __assign({ style: { padding: 8 } }, { children: [jsxRuntime.jsx(antd.Input, { placeholder: "\u641C\u7D22 ".concat(key === 'name' ? '系列名称' : key), value: selectedKeys[0], onChange: function (e) { return setSelectedKeys(e.target.value ? [e.target.value] : []); }, onPressEnter: function () {
                                    ...
                                    setSearchColumn(key);
                                }, style: { marginBottom: 8, display: 'block' } }), jsxRuntime.jsxs(antd.Space, { children: [jsxRuntime.jsx(antd.Button, __assign({ type: "primary", onClick: function () {
                                            confirm();
                                            setSearchText(selectedKeys[0]);
                                            setSearchColumn(key);
